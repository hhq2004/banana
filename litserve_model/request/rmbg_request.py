...
def call_rmbg_service(
    image,
    url=None,
):
    if not url:
        url = build_litserve_predict_url("rmbg")
...
if __name__ == "__main__":
    img = Image.open("/home/youzirui/code_dir_yzr/test_fig/rmbg_test.png")


    results = call_rmbg_service(img)
    
    results.save("/home/youzirui/code_dir_yzr/test_fig/rmbg_litserver.png")

"""
python /home/youzirui/code_dir_yzr/IMG2XML/backend/litserve_model/request/rmbg_request.py
"""