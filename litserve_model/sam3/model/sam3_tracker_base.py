...
from litserve_model.sam3.model.memory import SimpleMaskEncoder

from litserve_model.sam3.model.sam3_tracker_utils import get_1d_sine_pe, select_closest_cond_frames

from litserve_model.sam3.sam.mask_decoder import MaskDecoder, MLP
from litserve_model.sam3.sam.prompt_encoder import PromptEncoder
from litserve_model.sam3.sam.transformer import TwoWayTransformer
from litserve_model.sam3.train.data.collator import BatchedDatapoint
...
class Sam3TrackerBase(torch.nn.Module):
    ...
    def _compile_all_components(self):
        ...
        from litserve_model.sam3.perflib.compile import compile_wrapper
