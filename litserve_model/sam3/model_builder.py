...
# from litserve_model.sam3.model.decoder import (
#     TransformerDecoder,
#     TransformerDecoderLayer,
#     TransformerDecoderLayerv2,
#     TransformerEncoderCrossAttention,
# )
# from litserve_model.sam3.model.encoder import TransformerEncoderFusion, TransformerEncoderLayer
# from litserve_model.sam3.model.geometry_encoders import SequenceGeometryEncoder
# from litserve_model.sam3.model.maskformer_segmentation import PixelDecoder, UniversalSegmentationHead
# from litserve_model.sam3.model.memory import (
#     CXBlock,
#     SimpleFuser,
#     SimpleMaskDownSampler,
#     SimpleMaskEncoder,
# )
# from litserve_model.sam3.model.model_misc import (
#     DotProductScoring,
#     MLP,
#     MultiheadAttentionWrapper as MultiheadAttention,
#     TransformerWrapper,
# )
# from litserve_model.sam3.model.necks import Sam3DualViTDetNeck
# from litserve_model.sam3.model.position_encoding import PositionEmbeddingSine
# from litserve_model.sam3.model.sam1_task_predictor import SAM3InteractiveImagePredictor
# from litserve_model.sam3.model.sam3_image import Sam3Image, Sam3ImageOnVideoMultiGPU
# from litserve_model.sam3.model.sam3_tracking_predictor import Sam3TrackerPredictor
# from litserve_model.sam3.model.sam3_video_inference import Sam3VideoInferenceWithInstanceInteractivity
# from litserve_model.sam3.model.sam3_video_predictor import Sam3VideoPredictorMultiGPU
# from litserve_model.sam3.model.text_encoder_ve import VETextEncoder
# from litserve_model.sam3.model.tokenizer_ve import SimpleTokenizer
# from litserve_model.sam3.model.vitdet import ViT
# from litserve_model.sam3.model.vl_combiner import SAM3VLBackbone
# from litserve_model.sam3.sam.transformer import RoPEAttention
...
#     matcher = None
#     if not eval_mode:
#         from litserve_model.sam3.train.matcher import BinaryHungarianMatcherV2
...
#     SAM3_CKPT_NAME = "litserve_model.sam3.pt"
...
def build_sam3_image_model(
    ...
    if bpe_path is None:
        ...
        try:
            bpe_path = str(resource_files("sam3") / "assets" / "bpe_simple_vocab_16e6.txt.gz")
        except Exception:
            # 回退到手动路径拼接
            import litserve_model.sam3 as sam3_pkg
            bpe_path = os.path.join(os.path.dirname(sam3_pkg.__file__), "assets", "bpe_simple_vocab_16e6.txt.gz")
    ...
    if checkpoint_path is None:
        if not load_from_HF:
            # 本地ModelScope权重路径
            LOCAL_SAM3_DIR = "/home/wangyankun/models/sam3/"
            checkpoint_path = os.path.join(LOCAL_SAM3_DIR, "model.safetensors")
        else:
            # 从HF下载权重
            checkpoint_path = download_ckpt_from_hf()
